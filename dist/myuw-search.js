    ...
    _createClass(MyUWSearch, [{
      ...
      */
      ...
      value: function connectedCallback() {
        ...
        this.nonVisualHint = this.shadowRoot.querySelector('.visually-hidden'); // Set icon and label values
        ...
        this.$input.addEventListener('keyup', function (e) {
          if (_this2.$input.value.length > 0) {
            _this2.$button.setAttribute('aria-disabled', 'false');
          } else {
            _this2.$button.setAttribute('aria-disabled', 'true');
          }
      ...
      */
      ...
      value: function submitSearch(event) {
        ...
        event.stopPropagation(); // Add assistive technologies hint message when submitting search request
